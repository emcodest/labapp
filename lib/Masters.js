...
this.ListAcceptedTestsUnpartial = async (req, res) => {
    ...
    for (var r of list_master) {
        ...
        r.age = handler.ProcessAge(r.age)
        dresult.push([r.date, r.lab_no, r.sex, r.age, r.ref, r.code, "<button params = '"+r.lab_no+"'  func = 'PerformTest' class = \"app-btn bg-blue click\">perform</button>", "<button params = '"+r.acc_id+"'  func = 'PerformTest' class = \"app-btn bg-blue click\"><i class = 'fa fa-envelope'></button>"])
    }
