               ...
               // rcat[ii].tests.push({test_id: el.test_id, name: "XX"})
                ...
                if(! module.exports.CheckIfCatExist(catx[0].cat_name, rcat)){
                    ...
                    rcat.push({
                        ...
                        status_approve: el.status_approve,
                        status_partial: el.status_partial,
                        status_full:  el.status_full
                    })
           ...
           // console.log("$$$", elx.test_id)
            if(elx.test_type == "profile"){
                ...
                rcat.push({
                    ...
                    status_approve: elx.status_approve,
                    status_partial: elx.status_partial,
                    status_full:  elx.status_full
                })
