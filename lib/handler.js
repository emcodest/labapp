...
GetTestInfo: async (test_id, patient_id) => {
   // console.log("################", patient_id)
    ...
    var test_info = await module.exports.bindRawQuery("select test_code, test_name as name, ('') as value_1, ('') as value_2, unit_1, unit_2, lower_limit_1 as range_1_1, upper_limit_1 as range_2_1, lower_limit_2 as range_1_2, upper_limit_2 as range_2_2, formula_1, formula_2, report_type, summary, summary_2, summary_3, summary_4, ('') as prev_result_1, ('') as prev_result_2, ('') as value_1, ('') as value_2, ('') as para_value from test where id = $id", {id: test_id})
