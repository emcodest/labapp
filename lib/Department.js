...
this.AddTest = async (req, res) => {
    ...
    if(! report_type){
        handler.Error(res, "Report Type is empty")
        return
    }
    // check if code exist
...
this.EditTest = async (req, res) => {
    ...
    var {
        idd, code,formula_1,formula_2,lower_limit_1,lower_limit_2,name,rate,report_type,summary, summary_2, summary_3, summary_4,tax_per,unit_1,unit_2,upper_limit_1,upper_limit_2,test_order,test_cat_id
    } = req.body
    ...
    var mdata = {test_name: name, unit_1, unit_2, lower_limit_1: lower_limit_1, lower_limit_2: lower_limit_2, upper_limit_1: upper_limit_1, upper_limit_2: upper_limit_2, formula_1: formula_1, formula_2: formula_2, rate: rate, report_type: report_type, summary: summary, summary_2: summary_2, summary_3: summary_3, summary_4: summary_4, tax_per: tax_per}
